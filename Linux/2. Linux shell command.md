...
- mv 的 `source` 和 `target` 既可以是普通文件也可以是目录文件。
    ...
    [Untitled](https://www.notion.so/903f73f7af874c77910429e8bd44f000)
...
- ls 列出目录下的内容
    ...
    [ls -F 不同符号代表的文件类型](https://www.notion.so/b47cfe7de40940c380e3198c0b3b8ffc)
    ...
    [Untitled](https://www.notion.so/814edd0d376f4e03ac4105ea83a5c853)
